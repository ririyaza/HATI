// ─────────────────────────────────────────────
// HATI – Scene 3: The Approach & Professor Interaction
// screens/scene3_interaction.dart
//
// Adapted from testing_env/lib/scene3_interaction.dart. Backend steps
// `foa_s3_npc` / `foa_s3_reaction` map to this scene. The old hardcoded
// ResponseBranch-keyed reaction switch (confident/anxious/angry/freeze
// dialogue) is dropped entirely — professor dialogue and Hati's coaching
// text are read directly from provider.messages every turn, parsed by
// speaker prefix ("**Professor:**" / "**Narrator:**" / "**Hati:**").
//
...
// (ui.type == text_input) — the two turns are the opening line to the
// professor and the follow-up reply.
// ─────────────────────────────────────────────
...
const _kApproachBg = 'assets/professor_signature/classroom_bg.jpg';
const _kApproachProf = 'assets/professor_signature/prof.png';
...
class _Scene3InteractionState extends State<Scene3Interaction> {
  ...
  Future<void> _startRecording() async {
    if (await _record.hasPermission()) {
      ...
      final path = '${dir.path}/professor_signature_record.wav';
